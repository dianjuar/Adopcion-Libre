...
<html class="no-js"> <!--<![endif]-->
    ...
    <body >
      ...
      <article class="container padding-xlarge-left">
        ...
        <?php if($user_ID){ ?>
          <a id="btn-dar" href="<?php echo admin_url( 'edit.php?post_type=post&mode=list', 'http' ); ?>" class="btn BtnEncontrados">Dar en adopcion</a>
        <?php } ?>
      ...
      <script>
        $(document).ready(function(){
          ...
          $("ul.nav-justified li:nth-child(3)").toggleClass("BoxMenu--verdeActive");
